...
export default function AboutPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    about_paragraph1: "Lafto Mekaneyesus Youth Fellowship exists to help young people grow spiritually, discover their God-given gifts, build strong friendships and become faithful servants of Christ.",
    about_paragraph2: "Through Bible studies, worship, outreach, leadership training, and community service, we strive to glorify God while supporting one another in every stage of life.",
  });

  useEffect(() => {
    async function fetchData() {
      const [leadersRes, settingsRes] = await Promise.all([
        supabase.from("leaders").select("*").order("order_index", { ascending: true }),
        supabase.from("site_settings").select("key, value").in("key", ["about_title", "about_paragraph1", "about_paragraph2"]),
      ]);
        ...
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-blue-100">
              EECMY Lafto Mekaneyesus Congregation Youth Fellowship — a community
              of young people growing together in faith, friendship, and service.
            </p>
          </div>
        </Container>
      </section>
      ...
      <section className="py-24 bg-white">
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-slate-600 leading-relaxed">
              We are part of the Ethiopian Evangelical Church Mekane Yesus,
              one of the largest Lutheran churches in the world. Our congregation
              is located in the Lafto area of Addis Ababa, Ethiopia.
            </p>
